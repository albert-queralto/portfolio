...
upsert_env SERVER_WORKER_AMOUNT "1"
upsert_env API_WEBSOCKET_WORKER_AMOUNT "1"
upsert_env CELERY_WORKER_AMOUNT "1"
upsert_env CELERY_AUTO_SCALE "false"
upsert_env ENABLE_COLLABORATION_MODE "false"
upsert_env COMPOSE_PROFILES "weaviate,postgresql"
